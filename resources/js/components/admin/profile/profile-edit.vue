                            ...
                            <div class="col-lg-6">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <span class="input-group-addon"><i
                                            ...
                                            <input name="birth" type="date" class="form-control"
                                                   data-date-format="DD MMMM YYYY" placeholder="День рождения"
                                                   value="2000-01-01">
                                        </div>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                class="icofont icofont-htc-one"></i></span>
                                    ...
                                    <tr>
                                        <div class="input-group">
                                            ...
                                            <input name="passportDate" type="date" class="form-control"
                                                   placeholder="Дата выдачи паспорта" data-date-format="DD MMMM YYYY"
                                                   value="2015-08-09">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                class="icofont icofont-police"></i></span>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <div class="input-group">
                                            <input name="department" type="text" class="form-control"
                                                   placeholder="Название основной кафедры">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="input-group">
                                    ...
                                    <tr>
                                        <div class="input-group">
                                            <input name="education" type="text" class="form-control"
                                                   placeholder="Оконченный ВУЗ">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="input-group">
                                            <input name="year" type="text" class="form-control"
                                                   placeholder="Год окончания ВУЗ-а">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="input-group">
                                    ...
                                    <tr>
                                        <div class="input-group d-flex">
                                            ...
                                            <div class="col-md-2 d-flex justify-content-start">
                                                <input name="degreeYes" id="degreeNO" type="radio" class="pis"
                                                       value="0">
                                    ...
                                    <tr>
                                        <div class="input-group">
                                            <input name="degree" type="number" class="form-control"
                                                   placeholder="Ученая степень преподавателя" min="1">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="input-group">
                                            <input name="rank" type="number" class="form-control"
                                                   placeholder="Ученое звание преподавателя" min="1">
                                        </div>
                                    </tr>
                                    <tr>
                                        <div class="input-group">
                                            <input name="post" type="text" class="form-control"
                                                   placeholder="Занимаемая должность на кафедре">
                                        </div>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            save(e) {
                ...
                $('.form-send').serializeArray().map((val) => {
                    ...
                    if (val.name === 'degreeYes') {
                        this.formData.degreeYes = $('input[name="degreeYes"]:checked').val()
                    }
                });
